...
(function ($) {
    ...
    $("#priceRange").val("R$[" + $("#price-range").slider("values", 0) + "-" + $("#price-range").slider("values", 1) + "]");
    ...
    $("#roomsize-range-P").slider({
        ...
        values: [200, 999],
        slide: function (event, ui) {
            $("#roomsizeRangeP").val("[ " + ui.values[0] + " m²" + " - " + ui.values[1] + " m²" + " ]");
        }
    });
    $("#roomsizeRangeP").val("[ " + $("#roomsize-range-P").slider("values", 0) + " m²" + " - " + $("#roomsize-range-P").slider("values", 1) + " m²" + " ]");
